...
export default function UnifiedLogin() {
  ...
  const renderMethodTabs = () => (
    <div className="flex bg-gray-100 rounded-xl p-1 mb-6">
      {[
        { key: LOGIN_METHODS.PHONE, icon: PhoneIcon, label: 'Phone OTP' },
        { key: LOGIN_METHODS.EMAIL, icon: EnvelopeIcon, label: 'Email OTP' },
  ...
  return (
    <div className="animate-fadeIn">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-2">Welcome back to HireLink</p>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-6 text-center">
          <Link to="/register" className="btn-secondary w-full py-3">Create Account</Link>
        </div>
      </div>
    </div>
  )
